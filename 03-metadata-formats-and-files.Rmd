...
used to create the above map before you would feel comfortable using these data
to address a research question? 
* Think about the data used to create this plot.  If you had to share these data
...
system are used to store the data? Will they line up with other data? 
* **Resolution:** The dataset appears to be in **raster** format. This means it is
composed of pixels. What area on the ground does each pixel cover - i.e. What is 
the spatial resolution?

**Data Collection / Processing Methods**

* **When were the data collected?** Are they recent or historical?
* **How was the data generated?** Is this an output from a model, is it an image
...
* **Who do we contact:** We might need permission to use the data, have questions
...
imported data (e.g. **GeoTIFF** and **HDF5**). These data are contained in the same 
...
* Machine readable, which means you can use them in scripts and algorithms.
...
NOTE: These data and metadata are used in the 
...
metadata. Then, if the data are in a seperate file (e.g., structured or
unstructured metadata) make sure you save the metadata in a directory that is 
closely associated with wherever you save the data themselves! 
